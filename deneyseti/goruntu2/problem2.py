...
#gorutuyu iyilestirdim
img = cv2.imread("problem2.jpg",0)
kernel = np.ones((5,5),np.float32)/25
kernelone = np.ones((57,57))#dilation icin secilen matris
kernelTwo = np.ones((15,15))#erotion icın secilen matris
...
images = [equ, 0, th1,
          equ, 0, th2,
          blur, 0, th3]
erosion = cv2.erode(images[5],kernelone,iterations = 1)#local thresholding uyguladiktan sonra backgroundu yok etmek için  
dilation = cv2.dilate(erosion, kernelTwo, iterations=1)#kalan bölgeleri kalinlastirdimm
